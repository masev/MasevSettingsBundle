...
angular.module('xeditable').factory('editableController', 
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
    ...
    $scope.updateLabel = function(item, $data) {
        item.data = self.scope.BrowwseSelectedName;
    };

    $scope.selectContent = function(nodeId, name) {
        self.scope.$data = nodeId;
        self.scope.selected = nodeId;
        self.scope.BrowwseSelectedName = name;
